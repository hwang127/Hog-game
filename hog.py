...
def is_swap(player_score, opponent_score):
    ...
    if player_score>=100:
        ...
        left=player_score//10
    else:
        left=player_score
    return left==opponent_score%10
    # END PROBLEM 4
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    n=1
    for i in range(1,11):
        ave=make_averaged(roll_dice,num_samples)(i,dice)
        if ave>highest:
            highest=ave
            n=i
    return n
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if opponent_score>=score+free_bacon(opponent_score) and is_swap(score+free_bacon(opponent_score),opponent_score):
        return 0
    elif bacon_strategy(score,opponent_score,margin,num_rolls)==0 and not is_swap(score+free_bacon(opponent_score),opponent_score):
        return 0
    return num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if GOAL_SCORE-score<=free_bacon(opponent_score):
        return 0
    if GOAL_SCORE-score<=6:
        return 1
    if GOAL_SCORE-score<=10:
        return 2
    # BEGIN PROBLEM 12
    n=6
    return swap_strategy(score,opponent_score,8,n)
    # END PROBLEM 12
